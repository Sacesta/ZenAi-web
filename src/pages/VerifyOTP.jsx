...
const VerifyOTP = () => {
 ...
 // Replace the handleVerifyOTP function's catch block:
  ...
  return (
    <div className="common-container">
      ...
      <div className="common-card-center">
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '8px', background: 'transparent' }}>
            {[1, 2, 3, 4].map((index) => (
              <Form.Item
                key={index}
                name={`otp${index}`}
              ...
              >
                <Input
                  ...
                  maxLength={1}
                  style={{ textAlign: 'center', fontSize: '24px', background: 'transparent' }}
          ...
          <div style={{ textAlign: 'center', marginBottom: '16px' }}>
            <Text>Didn't receive the code? <a onClick={handleResendOTP} style={{ cursor: 'pointer' }}>Resend</a></Text>
          </div>
